...
import { useIntl, FormattedMessage, MicroAppWithMemoHistory, Link } from 'umi';
...
export default () => {
  ...
  return (
    <PageContainer>
      main
      <Card>
        <Link props={{app1: 111}} name='app1'  to="/app1/Welcome">app1</Link>
        <Alert
          message={intl.formatMessage({
            id: 'pages.welcome.alertMessage',
            defaultMessage: '更快更强的重型组件，已经发布 。main',
          })}
          type="success"
          showIcon
          banner
